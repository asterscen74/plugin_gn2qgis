...
__geonature_domain__: str = __plugin_md__.get("geonature").get("domain")
__geonature__: str = __plugin_md__.get("geonature").get("url")
__geonature_crs__: str = __plugin_md__.get("geonature").get("crs")
__geonature_version__: str = __plugin_md__.get("geonature").get("version")
__geonature_login__: str = "{0}/{1}".format(
    __plugin_md__.get("geonature").get("url"),
    __plugin_md__.get("geonature").get("login_url"),
)
__geonature_data__: str = "{0}/{1}".format(
    __plugin_md__.get("geonature").get("url"),
    __plugin_md__.get("geonature").get("data_url"),
)
__geonature_obs__: str = "{0}/{1}".format(
    __plugin_md__.get("geonature").get("url"),
    __plugin_md__.get("geonature").get("obs_url"),
)
